...
export default function SetupButtonBar({roundDisplay, setRoundDisplay}) {
    ...
    return (
            ...
            <div className={styles.setupButtonBar}>
                <button className={roundDisplay === 1 ? styles.active : styles.setupButton} onClick={() => changeDisplay(1)}>Round 1</button>
                <button className={roundDisplay === 2 ? styles.active : styles.setupButton} onClick={() => changeDisplay(2)}>Round 2</button>
                <button className={roundDisplay === 3 ? styles.active : styles.setupButton} onClick={() => changeDisplay(3)}>Round 3</button>
